...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO "+Utilidades.TABLA_RESERVA+"("+Utilidades.CAMPO_ID_RESERVA_USER+","+Utilidades.CAMPO_NOMBRE_MESA_RESERVA+","+Utilidades.CAMPO_FECHA+","+Utilidades.CAMPO_INICIO+","+Utilidades.CAMPO_ID_FIN+") VALUES ('Christian','Mesa estilo antiguo','12/05/2023','11:45 AM','3:00 PM')");
    }
